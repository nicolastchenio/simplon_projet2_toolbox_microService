...
# On définit une variable d'environnement pour forcer l'usage de SQLite pendant les tests
# On le fait AVANT d'importer app_api.modules.connect
...
engine = create_engine("sqlite:///./tests/test_db.sqlite", connect_args={"check_same_thread": False})
